...
#     """
#     Util function to get the path of pdb from the code because of how the data is stored
#     1emv, filename -> 1/e/m/v/filename
#     :param pdbcode:
#     :param filename:
#     :param prepend_dir: optional path to the database to return the actual path of the file
#     :return:
#     """
#     in_db_path = os.path.join(pdbcode[0], pdbcode[1], pdbcode[2], pdbcode[3])
#     if filename is not None:
#         in_db_path = os.path.join(in_db_path, filename)
#     if prepend_dir is not None:
#         in_db_path = os.path.join(prepend_dir, in_db_path)
#     return in_db_path
...
#     """
#
#     :param pldb: file object of the protein-ligand database in .txt format
#     :param database_path:  path to the actual protein-ligand database
#     :return: list of protein ligand system:
#     """
#     protlig_dict = {}
#     for line in pldb:
#         line = line.strip()
