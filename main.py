...
if __name__ == '__main__':
    ...
    # train_dataset = RMSDDataset(data_root=data_root, csv_to_read="df_rmsd_train.csv", rotate=rotate,
    #                             spacing=spacing, grid_size=grid_size, get_pl_instead=0.)

    data_root = "data/low_rmsd"
    train_dataset_1 = RMSDDataset(data_root=data_root, csv_to_read="df_rmsd_train.csv", rotate=rotate,
                                  spacing=spacing, grid_size=grid_size, get_pl_instead=0.1)
    train_dataset_2 = RMSDDataset(data_root="data/high_rmsd", csv_to_read="df_rmsd_train.csv", rotate=rotate,
                                  spacing=spacing, grid_size=grid_size, get_pl_instead=0.1)
    train_dataset_3 = RMSDDataset(data_root="data/double_rmsd", csv_to_read="df_rmsd_train.csv", rotate=rotate,
                                  spacing=spacing, grid_size=grid_size, get_pl_instead=0.1)
    train_dataset_4 = RMSDDataset(data_root="data/hd", csv_to_read="df_rmsd_HD_train.csv", rotate=rotate,
                                  spacing=spacing, grid_size=grid_size, get_pl_instead=0.)
